...
import { ChevronRight, Settings, ShoppingBag } from '@lucide/vue'
...
<template>
  ...
  <div class="absolute left-[320px] top-[56px] z-10 flex flex-col drawer-transition" :style="bookmarkStyle">
    <button
      ...
      class="w-7 py-4 bg-zinc-900 hover:bg-black text-white rounded-r-xl border-y border-r border-white/10 flex flex-col items-center gap-1.5 group"
      data-no-drag
    >
